  ...
  return (
    <div>
      <p className='pb-3 mt-12 font-medium text-zinc-700 border-b' >My Appointment</p>
        <div>
          {appointments.slice(0,2).map((item,id)=>(
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-6 border-b' key={id}>
              <div>
              ...
              <div></div>
               <div className='flex flex-col justify-end gap-2'>
                ...
                {!item.cancelled && !item.payment && <button onClick={()=>appointmentRazorpay(item._id)} className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-blue-600 hover:text-white transition-all duration-300'>Pay online</button>}  
