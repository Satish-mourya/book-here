...
const Login = () => {
    ...
    const onSubmitHandler = async (event)=>{
          event.preventDefault()// to not reload while submit
          try {
            if(state==='Admin'){
  ...
  return (
    <form onSubmit={onSubmitHandler} action="" className='min-h-[80vh] flex items-center'>
      ...
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border border-gray-100 rounded-xl text-gray-500 text-sm shadow-lg'>
